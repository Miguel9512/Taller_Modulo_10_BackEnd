...
<head>
    ...
    <!--CND BOOTSTARP-->
    <!--Se agrega etiqueta Link y por medio del atributo href llama a la
    hoja de estilos .css general usada en todos los puntos del taller.-->
...
<a href="index.html#section-respuestas">   
    ...
    <form action="" method="POST">
        ...
        <div class="form-group">
            ...
            <!--Se realiza corrección agregando atributo name ya que el
            valor "n2" se encontraba sin su correespondiente atributo.-->
        ...
        <div class="form-group">
            ...
            <!--Se realiza corrección agregando atributo value ya que el
            valor "2" se encontraba sin su correespondiente atributo.-->
    ...
    if (isset($_POST['operar'])) {
        ...
        echo "<h1>".$result."</h1>";
        /*La siguiente linea imprime el resultado de la operacion
        en una ventana de script (la dejo deshabilitada).*/
